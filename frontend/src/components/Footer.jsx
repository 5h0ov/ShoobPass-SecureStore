    ...
    return (
        <div>
            ...
            <span className="logo font-bold ">
                ...
                Shoob<span className='text-green-700'>Pass/&gt;</span>
            </span>.
            All Rights Reserved | Made by <a className="hover:underline" href="https://github.com/5h0ov" target="_blank"> Shuvadipta Das </a> </p>
